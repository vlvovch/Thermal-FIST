...
void ThermalModelVDWFull::SetChemicalPotentials(const vector<double>& chem)
{
...
void ThermalModelVDWFull::FillVirial(const vector<double> & ri) {
...
void ThermalModelVDWFull::FillVirialEV(const vector< vector<double> >& bij)
{
...
void ThermalModelVDWFull::FillAttraction(const vector<vector<double> >& aij)
{
...
void ThermalModelVDWFull::ReadInteractionParameters(const string & filename)
{
...
void ThermalModelVDWFull::WriteInteractionParameters(const string & filename)
{
...
vector<double> ThermalModelVDWFull::SearchSolutionsSingleBroydenOptimized(const vector<double>& muStarInit)
{
  const double EPS = 1.0e-10;
...
vector<double> ThermalModelVDWFull::SearchSolutionsSingleBroydenOptimized2(const vector<double>& muStarInit)
{
  const double EPS = 1.0e-10;
...
vector<double> ThermalModelVDWFull::CalculateChargeFluctuations(const vector<double> &chgs, int order) {
...
vector< vector<double> >  ThermalModelVDWFull::CalculateFluctuations(int order) {
