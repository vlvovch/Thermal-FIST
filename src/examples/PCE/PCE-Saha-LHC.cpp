...
{
	// The default particle list. As of version 1.6 this is PDG2025 list including light nuclei
	ThermalParticleSystem parts(ThermalFIST_DEFAULT_LIST_FILE);

	// To include excited nuclei use the following line instead
	//ThermalParticleSystem parts(string(ThermalFIST_INPUT_FOLDER) + "/list/PDG2025/list-withexcitednuclei.dat");
