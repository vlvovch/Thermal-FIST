...
ResultDialog::ResultDialog(QWidget *parent, ThermalModelBase *mod) :
    QDialog(parent), model(mod)//, fParticle(Particle), fTPS(TPS)
{
    ...
    this->setWindowTitle(tr("Thermal model results"));
